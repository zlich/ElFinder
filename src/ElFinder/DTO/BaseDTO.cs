...
namespace ElFinder
{
    ...
    {        
        ...
        //public static BaseDTO Create(IFileInfo info, Root root)
        //{
        //    if (info == null)
        ...
        //    response.UnixTimeStamp = (long)(info.LastWriteTimeUtc - s_unixOrigin).TotalSeconds;
        //    response.Mime = info.MimeType;
        ...
        //    return response;
        //}
        //public static BaseDTO Create(IDirectoryInfo directory, Root root)
        //{
        //    if (directory == null)
        ...
        //            Name = root.Alias,                    
        //            Size = 0,
        //            UnixTimeStamp = (long)(directory.LastWriteTimeUtc - s_unixOrigin).TotalSeconds,
        ...
        protected static readonly DateTime s_unixOrigin = new DateTime(1970, 1, 1, 0, 0, 0);
    }
}